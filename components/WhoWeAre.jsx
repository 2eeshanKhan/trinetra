...
//             We bring cutting-edge automation, seamless control, 
//             and reliable security systems to empower a connected lifestyle.
//           </p>

//           <button className="mt-6 px-6 py-3 rounded-full text-white font-semibold shadow-lg transition hover:opacity-90"
//             style={{
//               background: "linear-gradient(to right, #3592ea, #0a63b1)"
//             }}
//           >
//             Learn More →
//           </button>
...
//             viewport={{ once: true }}
//             className="mt-10 rounded-2xl bg-gradient-to-r from-[#091e42] to-[#3592ea] text-white p-6 flex gap-5 items-center"
//           >
//             {/* Video Thumbnail */}
//             <div className="relative w-32 h-32 rounded-xl overflow-hidden shadow-lg cursor-pointer">
//               <Image
//                 src="/who-video-thumb.jpg"
//                 alt="Smart Panel"
//                 fill
...
//               We tailor each smart home to your specific lifestyle needs.
//             </p>
//           </motion.div>
